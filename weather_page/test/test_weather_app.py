...
class TestModels(TestCase):
    def test_add_rows_to_db(self):
        row1 = WWOnlineTable.objects.create(date_time='2100-01-01', location='Rostov-on-Don',
                                            date_location='Rostov-on-Don|2100-01-01', maxtempC=0, mintempC=0,
                                            winddirDegree=0, windspeedKmph=0, cloudcover=0, totalSnow_cm=0, precipMM=0)
        row2 = WWOnlineTable.objects.create(date_time='2100-01-02', location='Rostov-on-Don',
                                            date_location='Rostov-on-Don|2100-01-02', maxtempC=0, mintempC=0,
                                            winddirDegree=0, windspeedKmph=0, cloudcover=0, totalSnow_cm=0, precipMM=0)
